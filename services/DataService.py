...
from ..models import db, Garden, GardenType, GardenBuddy, TemperatureData, BrightnessData, MoistureData, HeightData, SalinityData, PhData, GardenImage
...
class DataService:
    ...
    def storeTemperatureData(serial_id, air_temperature):
        try:
            ...
            if garden_buddy:
                gardenData = TemperatureData(garden_id = garden_buddy.garden_id, air_temperature = air_temperature, date_timestamp = date_timestamp )
    ...
    def storeMoistureData(serial_id, moisture):
        try:
            ...
            garden_buddy = GardenBuddy.query.filter_by(serial_id = serial_id).first()
            if garden_buddy:
                gardenData = MoistureData(garden_id = garden_buddy.garden_id,moisture = moisture, date_timestamp = date_timestamp )
    ...
    def storeSalinityData(serial_id, salinity):
        try:
            ...
            if garden_buddy:
                ...
                gardenData = SalinityData(garden_id = garden_buddy.garden_id, salinity = salinity, date_timestamp = date_timestamp )
    ...
    def storePhData(serial_id, ph):
        try:
            ...
            garden_buddy = GardenBuddy.query.filter_by(serial_id = serial_id).first()
            if garden_buddy:
                gardenData = PhData(garden_id = garden_buddy.garden_id, ph = ph, date_timestamp = date_timestamp )
    ...
    def storeBrightnessData(serial_id, brightness):
        try:
            ...
            garden_buddy = GardenBuddy.query.filter_by(serial_id = serial_id).first()
            if garden_buddy:
                gardenData = BrightnessData(garden_id = garden_buddy.garden_id, brightness = brightness, date_timestamp = date_timestamp )
    ...
    def storeHeightData(serial_id, height):
        try:
            ...
            garden_buddy = GardenBuddy.query.filter_by(serial_id = serial_id).first()
            if garden_buddy:
                gardenData = HeightData(garden_id = garden_buddy.garden_id, height = height, date_timestamp = date_timestamp )
