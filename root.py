...
def create_sample_garden_types():
    ...
    types = [
        {'plant_name': 'Rose', 'plant_description': 'Roses are woody perennial flowering plants of the genus Rosa, in the family Rosaceae, or the flower it bears.', 'ideal_ph_level': 6.0, 'ideal_temp_level': 20, 'ideal_moisture_level': 50, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Lavender', 'plant_description': 'Lavender is a flowering plant in the mint family Lamiaceae, native to the Mediterranean region.', 'ideal_ph_level': 6.5, 'ideal_temp_level': 25, 'ideal_moisture_level': 40, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Tomato', 'plant_description': 'The tomato is the edible berry of the plant Solanum lycopersicum, commonly known as a tomato plant.', 'ideal_ph_level': 6.0, 'ideal_temp_level': 22, 'ideal_moisture_level': 60, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Sunflower', 'plant_description': 'Helianthus annuus, the common sunflower, is a large annual forb of the genus Helianthus grown as a crop for its edible oil and edible fruits.', 'ideal_ph_level': 6.5, 'ideal_temp_level': 25, 'ideal_moisture_level': 60, 'ideal_soil_salinity': 10, 'ideal_light': 1.1},
        {'plant_name': 'Basil', 'plant_description': 'Basil, also called great basil, is a culinary herb of the family Lamiaceae.', 'ideal_ph_level': 6.0, 'ideal_temp_level': 20, 'ideal_moisture_level': 70, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Cactus', 'plant_description': 'Cacti are succulent plants in the family Cactaceae.', 'ideal_ph_level': 6.5, 'ideal_temp_level': 30, 'ideal_moisture_level': 20, 'ideal_soil_salinity': 0.2, 'ideal_light': 30},
        {'plant_name': 'Orchid', 'plant_description': 'Orchids are a diverse and widespread family of flowering plants.', 'ideal_ph_level': 5.5, 'ideal_temp_level': 20, 'ideal_moisture_level': 70, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Fern', 'plant_description': 'Ferns are a group of vascular plants that reproduce via spores and have neither seeds nor flowers.', 'ideal_ph_level': 6.0, 'ideal_temp_level': 18, 'ideal_moisture_level': 80, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Pineapple', 'plant_description': 'The pineapple is a tropical plant with edible multiple fruit consisting of coalesced berries.', 'ideal_ph_level': 5.5, 'ideal_temp_level': 25, 'ideal_moisture_level': 60, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1},
        {'plant_name': 'Rosemary', 'plant_description': 'Rosemary is a fragrant evergreen herb native to the Mediterranean.', 'ideal_ph_level': 6.5, 'ideal_temp_level': 22, 'ideal_moisture_level': 50, 'ideal_soil_salinity': 0.2, 'ideal_light': 1.1}
    ]
